...
const sections = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label:
                    "Visual Analysis of Spatiotemporal data and data exploration",
                text1:
...
const App = (props) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sectionEls = document.getElementsByClassName(
                "content-section"
            );
                ...
                {sections.map((section, si) => {
                    ...
                    return (
                        <Tabs.Tab
                            ...
                            active={active}
                        >
                            <div className="tab-part tab-icon">
                                {section.icon}
                            </div>
                            <div className="tab-part tab-title">
                                {section.title}
                            </div>
                        </Tabs.Tab>
                    );
